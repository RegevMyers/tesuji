...
fn log(log_type: Type, message: &str) {
    ...
    if let Some(main_log) = lines.next() {
        let symbol: ColoredString = log_type.into();
...
#[rustfmt::skip]
impl From<Type> for ColoredString {
...
#[allow(unused)]
pub fn unclear(message: &str) {
    log(Type::Unclear, message)
}
...
pub fn fatal(message: &str) {
    log(Type::Fatal, message)
}

#[allow(unused)]
pub fn location(message: &str) {
    log(Type::Location, message)
}

#[allow(unused)]
pub fn parrallel(message: &str) {
    log(Type::Parrallel, message)
}
...
pub fn hint(message: &str) {
    log(Type::Hint, message)
}

#[allow(unused)]
pub fn trace(message: &str) {
    log(Type::Trace, message)
}
